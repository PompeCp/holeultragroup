...
import { getHotelesuser, api } from "../servicios/index";
...
const Reservar = () => {
  ...
  const fetchHoteles = async () => {
    const datos = await getHotelesuser();
    console.log(datos);
    if (datos?.status === 200) {
      ...
      <div className="container__conten">
        ...
        <div className="container__conten__search-container">
          ...
          <Link
            ...
            to={`/reservarubi?param1=${encodeURIComponent(
              JSON.stringify(form)
            )}`}
          >
          ...
          <div key={item.id_hotel} className="container__card-container__card">
            <div>
              ...
              <div className="container__card-container__card-content">
                ...
                <Link
                  className="container__card-container__card-actions-link"
                  to={`/reservarubi/${item.id_hotel}`}
                >
                  reservar en este hotel
                </Link>
                </div>
                </div>
              </div>
